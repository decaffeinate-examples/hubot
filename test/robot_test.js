...
const {
  CatchAllMessage, EnterMessage, LeaveMessage, TextMessage, TopicMessage,
} = require('../src/message');
...
describe('Robot', () => {
  ...
  describe('Unit Tests', () => {
    ...
    return describe('#loadFile', () => {
      ...
      return describe('non-Function script', () => {
        beforeEach(function () {
          const module = require('module');
  ...
  return describe('Message Processing', () => {
    ...
    return describe('Response Middleware', () => {
      ...
      it('marks plaintext as plaintext', function (testDone) {
        ...
        return this.robot.receive(testMessage, () => {
          ...
          return this.robot.receive(testMessage2, () => {
